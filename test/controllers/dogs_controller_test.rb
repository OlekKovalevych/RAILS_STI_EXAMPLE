...
class DogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dog" do
    assert_difference("Dog.count") do
      post dogs_url, params: { dog: { clinic_id: @dog.clinic_id, name: @dog.name, user_id: @dog.user_id } }
    end
  ...
  test "should update dog" do
    patch dog_url(@dog), params: { dog: { clinic_id: @dog.clinic_id, name: @dog.name, user_id: @dog.user_id } }
