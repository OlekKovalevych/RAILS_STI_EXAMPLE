...
class CatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cat" do
    assert_difference("Cat.count") do
      post cats_url, params: { cat: { clinic_id: @cat.clinic_id, name: @cat.name, user_id: @cat.user_id } }
    end
  ...
  test "should update cat" do
    patch cat_url(@cat), params: { cat: { clinic_id: @cat.clinic_id, name: @cat.name, user_id: @cat.user_id } }
